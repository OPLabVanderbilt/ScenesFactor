...
- **Review** — the "Built trials — review" panel below the workspace shows every
  ...
  outlined**, and its filename. **Edit** loads a trial back into the workspace while
  leaving it in the list — change what you like, then **Save changes** (updates it in
  place, keeping its trial number) or **Cancel** (discards, trial untouched).
  **Remove** deletes it.
